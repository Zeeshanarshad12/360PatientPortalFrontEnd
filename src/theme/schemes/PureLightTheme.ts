...
const colors = {
  ...
  shadows: {
    ...
    primaryiconbtn: '6px 8px 12px #006AD447',
    warningiconbtn: '6px 8px 12px #F4B20047',
    dangericonbtn: '6px 8px 12px #E8141447',
    successiconbtn: '6px 8px 12px #1AB74847',
    settingiconbtn: '6px 8px 12px #006AD447'
  },
  layout: {
    general: {
      bodyBg: '#f2f5f9'
...
export const PureLightTheme = createTheme({
  ...
  colors: {
    ...
    shadows: {
      ...
      add: colors.shadows.successiconbtn,
      edit: colors.shadows.primaryiconbtn,
      cross: colors.shadows.warningiconbtn,
      print: colors.shadows.warningiconbtn,
      delete: colors.shadows.dangericonbtn,
      crossred: colors.shadows.dangericonbtn,
      save: colors.shadows.successiconbtn
    },
    alpha: {
      white: {
        5: alpha(themeColors.white, 0.02),
  ...
  components: {
    MuiTextField: {
      styleOverrides: {
        root: {
          '& .MuiInputBase-input': {
            // Add or modify placeholder styles here
            '&::placeholder': {
              // color: 'rgba(0, 0, 0, 0.54)' // Adjust placeholder color as needed
              color: '#a0aaba', // Adjust placeholder color as needed
              opacity: 1
            }
          },
    ...
    MuiYearPicker: {
      styleOverrides: {
        root: {
          // backgroundColor: "red",,
          '&.MuiYearPicker-root .Mui-disabled': {
            pointerEvents: 'none',
            cursor: 'not-allowed',
    ...
    MuiBackdrop: {
      styleOverrides: {
        root: {
          backgroundColor: alpha(darken(themeColors.primaryAlt, 0.7), 0),
    ...
    MuiCssBaseline: {
      styleOverrides: {
        ...
        body: {
          ...
          flex: 1,
          background: '#f6f8fa'
          // backgroundImage: `url("/statics/icons/Background.png")`,
    ...
    MuiTooltip: {
      styleOverrides: {
        tooltip: {
          ...
          border: '1px solid #1561D3',
          padding: '8px 16px',
          fontSize: 13
        },
        arrow: {
          color: alpha(colors.alpha.white['100'], 1),
          '&:before': {
            border: '1px solid #1561D3'
          }
        }
